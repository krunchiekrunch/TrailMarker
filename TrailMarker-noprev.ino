// This version of the code doesn't have the double clicking to go to previous coordinate, if sometimes single clicking doesn't trigger, you should try this version
...
void checkButton()
{
    ...
    if ((millis() - lastDebounceTime) > debounceDelay) {
        if (buttonState == LOW && lastButtonState == HIGH) {
            ...
            Serial.print("Switch pressed, switched to coordinate: ");
